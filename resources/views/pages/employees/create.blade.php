            ...
            <div id="content-wrapper" class="d-flex  flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <a href="{{ route('employees') }}" class="btn btn-secondary shadow mb-4 border-0 ">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="mt-4" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="inputGender" class="col-sm-2 col-form-label">Branch office</label>
                                            <div class="col-sm-3">
                                                <select class="custom-select @error('gender') is-invalid @enderror"
                                                    id="inputGender" name="gender">
                                                    <option selected disabled>Select Branch office</option>
                                                    <option value="Laki-laki">Office 1</option>
                                                    <option value="Perempuan">Office 2</option>
